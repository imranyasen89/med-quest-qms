  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        // Status colors for document lifecycle
        status: {
          ...
          obsolete: "hsl(var(--status-obsolete))",
          "obsolete-bg": "hsl(var(--status-obsolete-bg))",
        ...
        module: {
          ...
          instruments: "hsl(var(--module-instruments))",
          kpi: "hsl(var(--module-kpi))",
          risk: "hsl(var(--module-risk))",
          audit: "hsl(var(--module-audit))",
          capa: "hsl(var(--module-capa))",
        },
      },
      borderRadius: {
        lg: "var(--radius)",
